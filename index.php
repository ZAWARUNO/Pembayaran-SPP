...
<head>
	...
	<title>Pembayaran SPP SMKN 4 Palaembang</title>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" target="_blank"><strong>Aplikasi Pembayaran SPP</strong></a> - <a class="text-muted" target="_blank">&copy; BY M.Apriansyah<strong></strong></a>
							</p>
						</div>
					</div>
				</div>
